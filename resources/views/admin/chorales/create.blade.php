...
<head>
    ...
    <title>Créer Chorale - VoXY Admin</title>
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="px-4 py-5 sm:px-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Créer une nouvelle chorale</h3>
                <p class="mt-1 max-w-2xl text-sm text-gray-500">Ajouter une nouvelle chorale au système</p>
            </div>
            
            <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
                <form action="{{ route('admin.chorales.store') }}" method="POST">
                    @csrf
