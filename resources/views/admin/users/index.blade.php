            ...
            <div class="px-4 py-5 sm:px-6">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="mt-1 max-w-2xl text-sm text-gray-500">Gérez les comptes utilisateurs et leurs statuts</p>
                    </div>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    ...
                                    @else
                                        <form method="POST" action="{{ route('admin.users.disapprove', $user->id) }}" class="inline">
                                            @csrf
