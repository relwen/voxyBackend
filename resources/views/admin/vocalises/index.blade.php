    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
                <div>
                    <h3 class="text-lg leading-6 font-medium text-gray-900">Gestion des Vocalises</h3>
                    <p class="mt-1 max-w-2xl text-sm text-gray-500">Exercices de vocalises par chorale et partie vocale</p>
                </div>
                <div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                @if($vocalise->chorale)
                                    <a href="{{ route('admin.vocalises.by-chorale', $vocalise->chorale->id) }}" class="text-blue-600 hover:text-blue-900">
