...
<head>
    ...
    <title>Créer une Vocalise - VoXY Admin</title>
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="bg-white shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 sm:px-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Créer une nouvelle Vocalise</h3>
                <p class="mt-1 max-w-2xl text-sm text-gray-500">Ajouter un exercice de vocalise pour une chorale</p>
            </div>
            
            <form method="POST" action="{{ route('admin.vocalises.store') }}" enctype="multipart/form-data" class="px-4 py-5 sm:p-6">
                @csrf
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select name="voice_part" id="voice_part" required
                            ...
                            @foreach($voiceParts as $part)
                                <option value="{{ $part }}" {{ old('voice_part') == $part ? 'selected' : '' }}>
                                    {{ $part }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <!-- Fichier audio -->
                    <div class="sm:col-span-2">
                        <label for="audio_file" class="block text-sm font-medium text-gray-700">Fichier audio</label>
