        ...
        <header class="bg-white shadow-sm border-b">
            <div class="flex items-center justify-between px-6 py-4">
                <div class="flex items-center">
                    ...
                    <h2 class="ml-4 lg:ml-0 text-2xl font-bold text-gray-800">Gestion des Chorales</h2>
                </div>
        ...
        <main class="p-6">
            ...
            <div class="bg-white shadow-lg rounded-xl border border-gray-100">
                <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900">Liste des Chorales</h3>
                        <p class="text-sm text-gray-600">Créer et gérer les chorales</p>
                    </div>
                    <a href="{{ route('admin.chorales.create') }}" class="bg-primary hover:bg-primary text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                        <i class="fas fa-plus mr-2"></i>Nouvelle Chorale
                    </a>
                </div>
                    ...
                    <table class="min-w-full">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Membres</th>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-semibold text-gray-900">{{ $chorale->name }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-600">{{ Str::limit($chorale->description ?? '-', 50) }}</div>
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex gap-2">
                                        <a href="{{ route('admin.chorales.edit', $chorale->id) }}" class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded-lg text-xs font-medium transition-colors">
