...
<head>
    ...
    <title>Modifier la Catégorie - VoXY Admin</title>
...
<body class="bg-gray-100">
    ...
    <div class="max-w-2xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="px-4 py-5 sm:px-6">
                ...
                <p class="mt-1 max-w-2xl text-sm text-gray-500">Modifiez les informations de la catégorie "{{ $category->name }}"</p>
            </div>

            <form method="POST" action="{{ route('admin.categories.update', $category->id) }}" class="px-4 py-5 sm:p-6">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <div class="mt-1 flex items-center space-x-3">
                        ...
                        <input type="text" name="color_text" id="color_text" value="{{ old('color', $category->color ?: '#3B82F6') }}"
    ...
    <script>
        ...
        function updatePreview() {
            ...
            // Mettre à jour l'aperçu (vous pouvez ajouter du JavaScript pour mettre à jour l'aperçu en temps réel)
        }
    </script>
</body>
</html>
